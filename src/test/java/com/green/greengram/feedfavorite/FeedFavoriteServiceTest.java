...
class FeedFavoriteServiceTest {
    ...
    @Test
    void toggleFavorite() {
        FeedFavoriteToggleReq req1=new FeedFavoriteToggleReq();
        req1.setFeedId(1); req1.setUserId(2);
        FeedFavoriteToggleReq req2=new FeedFavoriteToggleReq();
        req2.setFeedId(1); req2.setUserId(3);
        FeedFavoriteToggleReq req3=new FeedFavoriteToggleReq();
        req3.setFeedId(1); req3.setUserId(4);

        //뭐지 뭐가 문제야...........
        given(mapper.delFeedFavorite(req1)).willReturn(1);
        //given(mapper.delFeedFavorite(req2)).willReturn(1);
        //given(mapper.delFeedFavorite(req3)).willReturn(0);

        assertEquals(1, service.toggleFavorite(req1), "1번");
        ...
        //verify(mapper).insFeedFavorite(req2);
